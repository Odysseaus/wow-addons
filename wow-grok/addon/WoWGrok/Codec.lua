-- WoWGrok pixel codec. Pure Lua, no WoW APIs, so it can be tested outside the game.
--
...
-- setting, unlike intermediate levels. bridge/capture.ps1 (Windows) and
-- bridge/capture-mac.js (macOS) decode it.
