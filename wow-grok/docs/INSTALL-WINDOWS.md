...
3. Double-click; enter your xAI API key; confirm your WoW **Interface/AddOns** folder. Type `/wow-grok` or `/grok` in game chat.
4. Leave it running while you play Forever. A **system tray** icon shows **Running**; use **Quit** there to stop.
